...
class StagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stage" do
    assert_difference("Stage.count") do
      post stages_url, params: { stage: { procedure_id: @stage.procedure_id, title: @stage.title } }
    end
  ...
  test "should update stage" do
    patch stage_url(@stage), params: { stage: { procedure_id: @stage.procedure_id, title: @stage.title } }
